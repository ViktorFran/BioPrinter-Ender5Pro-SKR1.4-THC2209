 ...
 */
#define E0_AUTO_FAN_PIN P2_04 //Changed for SKR1.4TURBO
...
#define ENDSTOPS_ALWAYS_ON_DEFAULT //Uncommented for testing
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS //Uncommented for monitoring driver status
